            ...
            <div className="row">
                    ...
                    <form className="card p-2">
                        <div className="input-group">
                            ...
                            <div className="input-group-append">
                                <button type="submit" className="btn btn-secondary " style={{marginTop:"30px"}}>Redeem</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div className="col-md-8 order-md-1">
                    ...
                    <div className="mb-3">
                        ...
                        <div className="input-group">
                            <div className="input-group-prepend">
                                <span className="input-group-text" style={{marginTop:"30px"}}>@</span>
                            </div>
                    ...
                    <div className="custom-control custom-checkbox">
                        ...
                        <label className="custom-control-label" for="same-address">Shipping address is the same as my
